...
def plot_temperature_change(df):
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig('/Users/Esdesu/Desktop/JreJre/BigData/HomeWork/BigData/Work#3/Task_1/screan/temp_change.png')
    plt.show()
...
def plot_temperature_distribution(df):
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig('/Users/Esdesu/Desktop/JreJre/BigData/HomeWork/BigData/Work#3/Task_1/screan/temp_distribution.png')
    plt.show()


data_path = Path("/Users/Esdesu/Desktop/JreJre/BigData/HomeWork/BigData/Work#3/Task_1/kaggle_wqather.csv")
